        ...
        <div class="card mt-4">
            ...
            <div class="card-header p-2">
                <form>
                    <div class="col-lg-2 col-md-3 col-sm-12 mt-2 p-0">
                        ...
                        <button v-if="connected === false" v-on:click="connect()" type="button" class="mr-2 btn btn-sm btn-primary w100">
                            Connect
                        </button>
                        <button v-if="connected === true" v-on:click="disconnect()" type="button" class="mr-2 btn btn-sm btn-danger w100">
                            Disconnect
                        </button>
                    </div>
            ...
            <form>
                ...
                <div class="row text-right mt-2">
                    ...
                    <div class="col-lg-2">
                        <button type="button"  v-on:click="sendMessage()"class="btn btn-small btn-primary w-100">Send Event</button>
        ...
        new Vue({
            ...
            methods: {
                ...
                subscribeToAllChannels(){
                    [
                        "api-message"
                    ].forEach(channelName => this.subscribeToChannels(channelName));
                },
